...
function MenuSuspenso() {
  ...
  function haddleExit2() {
    document
      ...
      .classList.remove("activeSuspenso");
  }
    ...
    <div className="containerMSuspenso">
      <div className="center-susp">
        <div className="center-susp-filho">
          <div onClick={haddleExit2} className="exit-recovery2">
            <span>Voltar</span>
          </div>
          <div>
            {photo.map((e, index) => {
      ...
      <div className="telas-opcoes">
        <div className="recovery-div-suspenso">
          <Recoverysenha />
        </div>
        <div className="deletar-conta22">
          <DeleteConta />
        </div>
      </div>
    </div>
